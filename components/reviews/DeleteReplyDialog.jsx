...
export const DeleteReplyDialog = ({ isOpen, onClose, onConfirm, isDeleting }) => {
  return (
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-text mb-2">Delete Reply</h3>
            <p className="text-text/70 mb-8 text-sm">
              Are you sure you want to delete this reply? This action cannot be undone and the customer will no longer see your response.
            </p>
